...
class PAAC:
    ...
    def train(self, states, actions, returns):
        ...
        with tf.GradientTape() as actor_tape:
            ...
            action_prob = tfp.distributions.Categorical(actor_actions)
            actor_loss = - action_prob.log_prob(actions) * (returns - predict_critic) - self.entropy_regularization * action_prob.entropy()
